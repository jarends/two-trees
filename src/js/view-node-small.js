...
(function() {
  var ViewNode, _, __id__, checkDom, classMap, create, dirty, dirtyMap, domList, map, nodeMap, performUpdate, rafTimeout, unmap, update,
  ...
  ViewNode = (function() {
    ...
    ViewNode.prototype.disposeNode = function(node) {
      var child, j, len, ref;
