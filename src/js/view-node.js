...
(function() {
  ...
  ViewNode = (function() {
    ...
    ViewNode.prototype.updateCfg = function(cfg1) {
      var key, ref, value;
      this.cfg = cfg1;
      if (this.cfg && this.cfg.inject) {
        this.inject = this.cfg.inject;
        ref = this.inject;
        for (key in ref) {
          value = ref[key];
          this[key] = value;
    ...
    ViewNode.prototype.updateProps = function(cfg) {
      var attr, ignore, key, name, propMap, updateChildren, value;
      if (this.updating) {
      ...
      } else if (this.children.length && updateChildren) {
        this.updateChildren([]);
      }
    ...
    ViewNode.prototype.changeChild = function(child, cfg) {
      ...
      if (_.isNodeInstance(cfg)) {
        ...
        if ((child.tag === cfg.tag && child.constructor === ViewNode) || child.constructor === cfg.tag) {
