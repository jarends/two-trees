...
(function() {
  var extendsNode, getOrCall, isArray, isBool, isDom, isDomText, isFunc, isNodeInstance, isNot, isNumber, isObject, isSimple, isSimpleOrNull, isString, normalizeEvent, normalizeName;
  ...
  isSimpleOrNull = function(value) {
    var t;
    return value === null || (t = typeof value) === 'string' || t === 'number' || t === 'boolean';
  };
